...
if __name__ == "__main__":
    from Models import Encoder_Transformer
else:
    from utils.Models import Encoder_Transformer
...
class ACAgent:
    ...
    def choose_action(self, observation, valid_actions):
        ...
        masked_dist = torch.distributions.Categorical(masked_probs)

        action = masked_dist.sample()

        log_prob = masked_dist.log_prob(action).item()
        action = action.item()
